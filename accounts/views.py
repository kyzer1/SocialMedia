...
class UserRegisterView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            messages.success(request, 'you have registered successfuly', 'success')
            return redirect('home:home')
        return render(request, self.template_name, context={'form': form})
...
class UserLoginView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if user is not None:
                login(request, user)
                messages.success(request, 'you have logged in successfuly', 'success')
                if self.next:
...
class UserLogoutView(LoginRequiredMixin, View):
    def get(self, request):
        logout(request)
        messages.success(request, 'you have logged out successfuly', 'success')
...
class userPassworResetCompleteView(auth_views.PasswordResetCompleteView):
...
class UserUnFollowView(LoginRequiredMixin, View):
    def get(self, request, user_id):
        ...
        if relation.exists():
            ...
            messages.success(request, 'you are not following this user', 'danger')
        return redirect('accounts:user_profile', user_id)
